(() => {
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\gallery.ts
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\menu.ts
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\createElement.ts
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\colorScheme.ts
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\scrollspy.ts
  ...
  // ns-hugo-imp:D:\daimacang\website_blog\hugo-test\themes\hugo-theme-stack-3.32.0\assets\ts\smoothAnchors.ts
  ...
  var Stack = {
    init: () => {
      ...
      highlights.forEach((highlight) => {
        ...
        if (!codeBlock) return;
        const getCodeText = () => {
          const codeLines = codeBlock.querySelectorAll("tr td:last-child");
        ...
        copyButton.addEventListener("click", () => {
          navigator.clipboard.writeText(getCodeText()).then(() => {
